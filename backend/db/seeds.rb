...
bengaluru = City.create(name: "Bengaluru", state: "Karnataka", country: "India", continent: "Asia", language_name: "kannada",globe_emoji: "🌏", image_key: "rwyMGYLiJIeHA1vQVdbzIg", flag_url: "https://cdn.britannica.com/97/1597-004-05816F4E/Flag-India.jpg", flag_emoji: "🇮🇳", food: bengaluru_food, language: bengaluru_language, religion: bengaluru_religion, initial_greetings: kannadaInitialGreetings, dont_understand: kannadaDontUnderstand, greetings: kannadaGreetings, ok: kannadaOK, correct: kannadaCorrect)
